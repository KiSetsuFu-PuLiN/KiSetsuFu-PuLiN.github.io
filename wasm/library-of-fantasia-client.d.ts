...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1341: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4472: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1990: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1990_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4294: (a: number, b: number) => void;
