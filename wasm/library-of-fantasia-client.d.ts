...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4398: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1288: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3048: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3048_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_350: (a: number, b: number) => void;
