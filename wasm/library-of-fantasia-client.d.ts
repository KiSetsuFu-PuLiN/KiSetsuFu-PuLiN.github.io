...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1640: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9017: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4233: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4233_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_7083: (a: number, b: number) => void;
