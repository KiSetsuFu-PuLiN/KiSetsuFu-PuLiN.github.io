...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1549: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2596: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4441: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4441_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4441_3: (a: number, b: number, c: number) => void;
