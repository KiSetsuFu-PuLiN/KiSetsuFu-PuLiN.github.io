...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_620: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1633: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3190: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3190_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3190_3: (a: number, b: number, c: number) => void;
