...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_7513: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3197: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3197_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3197_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_6579: (a: number, b: number) => void;
