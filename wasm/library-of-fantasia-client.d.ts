...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4613: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_289: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4531: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4531_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4531_3: (a: number, b: number, c: number) => void;
