...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_6470: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_780_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_721: (a: number, b: number) => void;
