...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1742: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1851: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2223: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2223_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2223_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1361: (a: number, b: number) => void;
