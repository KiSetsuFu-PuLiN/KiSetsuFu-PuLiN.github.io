...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3759: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1225: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_380: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_380_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_380_3: (a: number, b: number, c: number) => void;
