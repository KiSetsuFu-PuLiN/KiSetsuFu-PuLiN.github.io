...
export const __wasm_bindgen_func_elem_2812: (a: number, b: number, c: number, d: number) => void;
...
export const __wasm_bindgen_func_elem_1022_2: (a: number, b: number, c: number) => void;
