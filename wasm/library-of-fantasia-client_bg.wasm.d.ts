...
export const __wasm_bindgen_func_elem_4593: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_4593_2: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_782: (a: number, b: number) => void;
