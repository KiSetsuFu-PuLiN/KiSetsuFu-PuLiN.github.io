...
export const __wasm_bindgen_func_elem_998: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1820: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_4327: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_4327_2: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_874: (a: number, b: number) => void;
