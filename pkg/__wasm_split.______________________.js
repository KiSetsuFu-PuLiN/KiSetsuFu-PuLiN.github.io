...
export const __wasm_split_load___upload_route_view_6063885457500064581 = wrapAsyncCb(makeLoad(new URL("./split___upload_route_view_6063885457500064581.wasm", import.meta.url), [__chunk_7, __chunk_8, __chunk_10, __chunk_11, __chunk_12, __chunk_13]));
export const __wasm_split_load___settings_route_view_17963179042528677915 = wrapAsyncCb(makeLoad(new URL("./split___settings_route_view_17963179042528677915.wasm", import.meta.url), [__chunk_6, __chunk_7, __chunk_9, __chunk_10, __chunk_13]));
export const __wasm_split_load___preview_route_view_16461140826036237788 = wrapAsyncCb(makeLoad(new URL("./split___preview_route_view_16461140826036237788.wasm", import.meta.url), [__chunk_5, __chunk_6, __chunk_7, __chunk_8, __chunk_12]));
